...
- **Image toolchain:** `.cursor/Dockerfile` stays on Ubuntu 24.04 and PostgreSQL 16. It pins Node.js 22.14.0 (npm included), corepack 0.34.7, and pnpm 12.5.1. See [EDR-002](docs/20-engineering/engineering-build-record.md#edr-002-cloud-agent-node-toolchain).
...
| 1.3.1 | 2026-09-26 | Section 9 records the Cloud Agent image toolchain: Ubuntu 24.04, PostgreSQL 16, Node.js 22.14.0, corepack 0.34.7, and pnpm 12.5.1. No product behavior or merge policy changed. |
