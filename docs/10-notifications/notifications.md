...
**Ownership decision:** Notifications is created at `docs/10-notifications/notifications.md` under the governed `NOTIFICATIONS` token. No Governance or Foundation change was required.
