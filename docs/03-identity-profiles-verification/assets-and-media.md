...
| Dispute Evidence | **Unresolved — case domain or Moderation** | Authorized case party, assigned Moderator, or Administrator | Case parties as owning policy permits; assigned Moderator/Administrator | Relationship Restricted | Approved evidence classes / `ATTACH-M` | Dispute, financial, legal, and regulatory policy | Scan, preserve original hash, limited preview; case moderation | Legal/dispute hold overrides erasure until release | Not Implemented |
